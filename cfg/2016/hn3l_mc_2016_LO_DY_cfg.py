# heppy_batch.py -o lo_dy_2016_15may20_v1 hn3l_mc_2016_LO_DY_cfg.py -B -b 'run_condor_simple.sh -t 1440 ./batchScript.sh'
...
SF_FILE = '$CMSSW_BASE/src/CMGTools/HNL/data/LegacyCorrectionsWorkspace/output/htt_scalefactors_legacy_2016.root' # KIT, the best, by far
...
MU_SFS = OrderedDict()
MU_SFS['id'  ] = (SF_FILE, 'm_id' )
MU_SFS['iso' ] = (SF_FILE, 'm_iso')
# MU_SFS['reco'] = (SF_FILE, 'm_trk')
# Add trigger corrections for the prompt lepton l0
MU_PROMPT_SFS = dc(MU_SFS)
MU_PROMPT_SFS['trigger'] = (SF_FILE, 'm_trg')

###################################################
###               HANDLE SAMPLES                ###
###################################################
# samples = all_samples + all_signals
samples = [DYJetsToLL_M50_ext1, DYJetsToLL_M50_ext2]
###################################################
...
#     jetCol            = 'slimmedJets',
    ...
    mc_eff_file       = os.environ['CMSSW_BASE'] + '/src/CMGTools/HNL/data/btag/eff/btag_deepflavour_wp_medium_efficiencies_2016.root',
    sf_file           = os.environ['CMSSW_BASE'] + '/src/CMGTools/HNL/data/btag/sf/2016/DeepJet_2016LegacySF_WP_V1.csv',
...
if recompute_deepjet:
    fname = os.environ['CMSSW_BASE'] + '/src/CMGTools/HNL/python/prod/cmg/update_deepjet_and_ele_id_mc2016_cmg_cfg.py'
