# heppy_batch.py -o data_2017_15may20_v1 hn3l_data_2017_all_cfg.py -B -b 'run_condor_simple.sh -t 2880 ./batchScript.sh'
...
from CMGTools.HNL.triggers.triggers_2017 import triggers_ele_data, triggers_mu_data, triggers_and_filters_ele, triggers_and_filters_mu
...
if recompute_deepjet:
    fname = os.environ['CMSSW_BASE'] + '/src/CMGTools/HNL/python/prod/cmg/update_deepjet_and_ele_id_data2017_cmg_cfg.py'
