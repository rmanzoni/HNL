...
## MC SIGNAL HNL
# Processing History:
#   SIM '' '"CMSSW_10_2_16_patch1"' [1]  (e838c948625955df932de940e32b8373)
#     HLT '' '"CMSSW_10_2_5"' [1]  (96e2d90999375d8c542ea905b43803e1)
#       RECO '' '"CMSSW_10_2_5"' [1]  (2fd59cbde119ecab78af65e08efe8aae)
#         PAT '' '"CMSSW_10_2_5"' [1]  (3ee3afd6b5a1410aea6d0b4d52723d06)

##########################################################################################
## MC CENTRAL PROD
# Processing History:
#   SIM '' '"CMSSW_10_2_3"' [1]  (fd41c8867e3b0df55f1afdc204013263)
#     HLT '' '"CMSSW_10_2_5"' [1]  (96e2d90999375d8c542ea905b43803e1)
#       RECO '' '"CMSSW_10_2_5"' [1]  (2fd59cbde119ecab78af65e08efe8aae)
#         PAT '' '"CMSSW_10_2_5"' [1]  (3ee3afd6b5a1410aea6d0b4d52723d06)
...
## DATA 2018D
# Processing History:
#   LHC '' '"CMSSW_10_1_9_patch1"' [1]  (dd392193a5747b5c718c2371e7635ff9)
#     HLT '' '"CMSSW_10_1_9_patch1"' [1]  (304cdc4994e6da01c984d6baff699866)
#       RECO '' '"CMSSW_10_2_5_patch1"' [1]  (306144291bb2d755797972fd22d33d6d)
#     HLT '' '"CMSSW_10_1_9_patch1"' [2]  (35855b30974db48a1527cdef5145ed74)
#       RECO '' '"CMSSW_10_2_5_patch1"' [1]  (306144291bb2d755797972fd22d33d6d)
#   LHC '' '"CMSSW_10_1_10"' [2]  (dd392193a5747b5c718c2371e7635ff9)
#     HLT '' '"CMSSW_10_1_10"' [1]  (dc39729c5bfbe01472935c744428f877)
#       RECO '' '"CMSSW_10_2_5_patch1"' [1]  (306144291bb2d755797972fd22d33d6d)


# to fetch the HLT menu
# edmProvDump heavyNeutrino_1.root  -i 96e2d90999375d8c542ea905b43803e1 | grep tableName

'''
# https://twiki.cern.ch/twiki/bin/view/CMSPublic/SWGuideGlobalHLT#Dumping_the_latest_HLT_menu_conf

hltGetConfiguration /frozen/2018/2e34/v3.2/HLT/V1 --full --offline --mc --unprescale --process TEST --globaltag auto:run2_mc_GRun > hlt.py

hltGetConfiguration /frozen/2018/2e34/v3.2/HLT/V1 \
--full \
--offline \
--mc \
--unprescale \
--process PFHLT \
--globaltag PRE_LS171V9A::All \
--paths HLT_IsoMu24_v1 > hlt_onlyMu24.py
'''
...
### MC TRIGGERS
##########################################################################################
#   @trigger_paths: vstring tracked  = {'digitisation_step',
# 'datamixing_step',
# 'L1simulation_step',
# 'digi2raw_step',
# 'HLTriggerFirstPath',
