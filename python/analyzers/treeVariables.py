...
# electron
electron_vars = [
    Variable('id_cut_l'            , lambda ele : ele.electronID('cutBasedElectronID-Fall17-94X-V2-loose' )),
    Variable('id_cut_m'            , lambda ele : ele.electronID('cutBasedElectronID-Fall17-94X-V2-medium')),
    Variable('id_cut_t'            , lambda ele : ele.electronID('cutBasedElectronID-Fall17-94X-V2-tight' )),
    Variable('id_cut_v'            , lambda ele : ele.electronID('cutBasedElectronID-Fall17-94X-V2-veto'  )),
    Variable('id_mva_iso_80'       , lambda ele : ele.electronID('mvaEleID-Fall17-iso-V2-wp80'            )),
    Variable('id_mva_iso_90'       , lambda ele : ele.electronID('mvaEleID-Fall17-iso-V2-wp90'            )),
    Variable('id_mva_iso_hzz'      , lambda ele : ele.electronID('mvaEleID-Fall17-iso-V2-wpHZZ'           )),
    Variable('id_mva_iso_l'        , lambda ele : ele.electronID('mvaEleID-Fall17-iso-V2-wpLoose'         )),
    Variable('id_mva_niso_80'      , lambda ele : ele.electronID('mvaEleID-Fall17-noIso-V2-wp80'          )),
    Variable('id_mva_niso_90'      , lambda ele : ele.electronID('mvaEleID-Fall17-noIso-V2-wp90'          )),
    Variable('id_mva_niso_l'       , lambda ele : ele.electronID('mvaEleID-Fall17-noIso-V2-wpLoose'       )),
