...
# electron
electron_vars = [
    Variable('id_cut_l'            , lambda ele : ele.electronID('cutBasedElectronID-Fall17-94X-V2-loose' .replace('-','_'))),
    Variable('id_cut_m'            , lambda ele : ele.electronID('cutBasedElectronID-Fall17-94X-V2-medium'.replace('-','_'))),
    Variable('id_cut_t'            , lambda ele : ele.electronID('cutBasedElectronID-Fall17-94X-V2-tight' .replace('-','_'))),
    Variable('id_cut_v'            , lambda ele : ele.electronID('cutBasedElectronID-Fall17-94X-V2-veto'  .replace('-','_'))),
    Variable('id_mva_iso_80'       , lambda ele : ele.electronID('mvaEleID-Fall17-iso-V2-wp80'            .replace('-','_'))),
    Variable('id_mva_iso_90'       , lambda ele : ele.electronID('mvaEleID-Fall17-iso-V2-wp90'            .replace('-','_'))),
    Variable('id_mva_iso_hzz'      , lambda ele : ele.electronID('mvaEleID-Fall17-iso-V2-wpHZZ'           .replace('-','_'))),
    Variable('id_mva_iso_l'        , lambda ele : ele.electronID('mvaEleID-Fall17-iso-V2-wpLoose'         .replace('-','_'))),
    Variable('id_mva_niso_80'      , lambda ele : ele.electronID('mvaEleID-Fall17-noIso-V2-wp80'          .replace('-','_'))),
    Variable('id_mva_niso_90'      , lambda ele : ele.electronID('mvaEleID-Fall17-noIso-V2-wp90'          .replace('-','_'))),
    Variable('id_mva_niso_l'       , lambda ele : ele.electronID('mvaEleID-Fall17-noIso-V2-wpLoose'       .replace('-','_'))),
    Variable('id_hnl_l_niso'       , lambda ele : ele.LooseNoIsoID()                  ),
    Variable('id_hnl_m_niso'       , lambda ele : ele.MediumNoIsoID()                 ), 
    Variable('id_hnl_m_iso'        , lambda ele : ele.MediumWithIsoID()               ),
    ...
    Variable('dEtaInSeed'          , lambda ele : ele.dEtaInSeed()                    ), 
    Variable('dPhiSCTrackatVtx'    , lambda ele : ele.deltaPhiSuperClusterTrackAtVtx()), 
    Variable('full5x5sigmaIEtaIEta', lambda ele : ele.full5x5_sigmaIetaIeta()         ),
...
muon_vars = [
    ...
    Variable('id_hnl_m'                   , lambda muon : muon.Medium()                                       ),
