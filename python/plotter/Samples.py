...
from CMGTools.HNL.samples.samples_mc_2017 import TTJets_amcat, TTJets_mdgrph, DYJetsToLL_M50, DYJetsToLL_M50_ext, WJetsToLNu, W3JetsToLNu, W4JetsToLNu, WLLJJ_WToLNu_EWK, WW_DoubleScattering, WZTo3LNu, ZZTo4L, ZZTo4L_ext
from CMGTools.HNL.samples.signal import HN3L_M_2_V_0p01_mu_massiveAndCKM_LO  as HN3L_M2_mu #.ctau =?
from CMGTools.HNL.samples.signal import HN3L_M_2_V_0p01_e_massiveAndCKM_LO as HN3L_M2_e #.ctau = ?
from CMGTools.HNL.samples.signal_old import HN3L_M_3_V_0p00316227766017_e_onshell  as HN3L_M3_e #.ctau = 14.6 cm
# from CMGTools.HNL.samples.signal_old import HN3L_M_1_V_0p00282842712475_e_onshell  as HN3L_M3_e #.ctau = 14.6 cm
from CMGTools.HNL.samples.signal_old import HN3L_M_3_V_0p00316227766017_mu_onshell as HN3L_M3_m #.ctau = 14.6 cm
...
from CMGTools.HNL.samples.samples_mc_2017_noskim   import ggZZTo2e2mu, ggZZTo2e2mu_ext, ggZZTo2e2nu, ggZZTo2e2nu_ext, ggZZTo2e2tau, ggZZTo2e2tau_ext, ggZZTo2mu2nu,  ggZZTo2mu2nu_ext, ggZZTo2mu2tau, ggZZTo2mu2tau_ext, ggZZTo4e, ggZZTo4mu, ggZZTo4tau
from CMGTools.HNL.samples.samples_mc_2017_noskim   import W1JetsToLNu,W2JetsToLNu,W3JetsToLNu,W4JetsToLNu
...
#        data_dir = '/eos/user/m/manzoni/HNL/singleele_e_23_08_2018/'              # first version
        data_dir = '/eos/user/v/vstampf/ntuples/data_2017_e_noskim/'  #second version
    ...
    if channel == 'm': 
        samples_essential += [SampleCfg(name='WJetsToLNu'       , dir_name=WJetsToLNu        .name, ana_dir=analysis_dir+bkg_dir, tree_prod_name=tree_prod_name, xsec=WJetsToLNu        .xSection, sumweights=WJetsToLNu        .nGenEvents)]
...
#            SampleCfg(name='W4JetsToLNu'       , dir_name=W4JetsToLNu        .name, ana_dir=analysis_dir+bkg_dir, tree_prod_name=tree_prod_name, xsec=W4JetsToLNu        .xSection, sumweights=W4JetsToLNu        .nGenEvents)
    ...
    samples_signal_e = [
       # SampleCfg(name='HN3L_M2_e' , dir_name=HN3L_M2_e.name, ana_dir=analysis_dir+sig_dir, tree_prod_name=tree_prod_name, xsec=signal_scale, sumweights=HN3L_M2_e.nGenEvents, is_signal=True)
       SampleCfg(name='HN3L_M3_e' , dir_name=HN3L_M3_e.name, ana_dir=analysis_dir+sig_dir, tree_prod_name=tree_prod_name, xsec=signal_scale, sumweights=HN3L_M3_e.nGenEvents, is_signal=True)
    ]
    samples_signal_m = [
...
#         SampleCfg(name='WLLJJ_WToLNu_EWK'   , dir_name=WLLJJ_WToLNu_EWK   .name, ana_dir=analysis_dir+bkg_dir, tree_prod_name=tree_prod_name, xsec=WLLJJ_WToLNu_EWK   .xSection, sumweights=WLLJJ_WToLNu_EWK   .nGenEvents),        
    ...
    samples_additional_m = [
        SampleCfg(name='ggZZTo2e2mu'           , dir_name=ggZZTo2e2mu    .name, ana_dir=analysis_dir+bkg_dir, tree_prod_name=tree_prod_name, xsec=ggZZTo2e2mu    .xSection, sumweights=ggZZTo2e2mu    .nGenEvents),
        SampleCfg(name='ggZZTo2e2mu_ext'           , dir_name=ggZZTo2e2mu_ext    .name, ana_dir=analysis_dir+bkg_dir, tree_prod_name=tree_prod_name, xsec=ggZZTo2e2mu_ext    .xSection, sumweights=ggZZTo2e2mu_ext    .nGenEvents),
        SampleCfg(name='ggZZTo2e2nu'           , dir_name=ggZZTo2e2nu    .name, ana_dir=analysis_dir+bkg_dir, tree_prod_name=tree_prod_name, xsec=ggZZTo2e2nu    .xSection, sumweights=ggZZTo2e2nu    .nGenEvents),
        SampleCfg(name='ggZZTo2e2nu_ext'           , dir_name=ggZZTo2e2nu_ext    .name, ana_dir=analysis_dir+bkg_dir, tree_prod_name=tree_prod_name, xsec=ggZZTo2e2nu_ext    .xSection, sumweights=ggZZTo2e2nu_ext    .nGenEvents),
        SampleCfg(name='ggZZTo2e2tau'           , dir_name=ggZZTo2e2tau    .name, ana_dir=analysis_dir+bkg_dir, tree_prod_name=tree_prod_name, xsec=ggZZTo2e2tau    .xSection, sumweights=ggZZTo2e2tau    .nGenEvents),
        SampleCfg(name='ggZZTo2e2tau_ext'           , dir_name=ggZZTo2e2tau_ext    .name, ana_dir=analysis_dir+bkg_dir, tree_prod_name=tree_prod_name, xsec=ggZZTo2e2tau_ext    .xSection, sumweights=ggZZTo2e2tau_ext    .nGenEvents),
        SampleCfg(name='ggZZTo2mu2nu'           , dir_name=ggZZTo2mu2nu    .name, ana_dir=analysis_dir+bkg_dir, tree_prod_name=tree_prod_name, xsec=ggZZTo2mu2nu    .xSection, sumweights=ggZZTo2mu2nu    .nGenEvents),
        SampleCfg(name='ggZZTo2mu2nu_ext'           , dir_name=ggZZTo2mu2nu_ext    .name, ana_dir=analysis_dir+bkg_dir, tree_prod_name=tree_prod_name, xsec=ggZZTo2mu2nu_ext    .xSection, sumweights=ggZZTo2mu2nu_ext    .nGenEvents),
        SampleCfg(name='ggZZTo2mu2tau'           , dir_name=ggZZTo2mu2tau    .name, ana_dir=analysis_dir+bkg_dir, tree_prod_name=tree_prod_name, xsec=ggZZTo2mu2tau    .xSection, sumweights=ggZZTo2mu2tau    .nGenEvents),
        SampleCfg(name='ggZZTo2mu2tau_ext'           , dir_name=ggZZTo2mu2tau_ext    .name, ana_dir=analysis_dir+bkg_dir, tree_prod_name=tree_prod_name, xsec=ggZZTo2mu2tau_ext    .xSection, sumweights=ggZZTo2mu2tau_ext    .nGenEvents),
        SampleCfg(name='ggZZTo4e'           , dir_name=ggZZTo4e    .name, ana_dir=analysis_dir+bkg_dir, tree_prod_name=tree_prod_name, xsec=ggZZTo4e    .xSection, sumweights=ggZZTo4e    .nGenEvents),
        SampleCfg(name='ggZZTo4mu'           , dir_name=ggZZTo4mu    .name, ana_dir=analysis_dir+bkg_dir, tree_prod_name=tree_prod_name, xsec=ggZZTo4mu    .xSection, sumweights=ggZZTo4mu    .nGenEvents),
        SampleCfg(name='ggZZTo4tau'           , dir_name=ggZZTo4tau    .name, ana_dir=analysis_dir+bkg_dir, tree_prod_name=tree_prod_name, xsec=ggZZTo4tau    .xSection, sumweights=ggZZTo4tau    .nGenEvents),
        SampleCfg(name='W1JetsToLNu'           , dir_name=W1JetsToLNu    .name, ana_dir=analysis_dir+bkg_dir, tree_prod_name=tree_prod_name, xsec=W1JetsToLNu    .xSection, sumweights=W1JetsToLNu    .nGenEvents),
        SampleCfg(name='W2JetsToLNu'           , dir_name=W2JetsToLNu    .name, ana_dir=analysis_dir+bkg_dir, tree_prod_name=tree_prod_name, xsec=W2JetsToLNu    .xSection, sumweights=W2JetsToLNu    .nGenEvents),
        SampleCfg(name='W3JetsToLNu'           , dir_name=W3JetsToLNu    .name, ana_dir=analysis_dir+bkg_dir, tree_prod_name=tree_prod_name, xsec=W3JetsToLNu    .xSection, sumweights=W3JetsToLNu    .nGenEvents),
        SampleCfg(name='W4JetsToLNu'           , dir_name=W4JetsToLNu    .name, ana_dir=analysis_dir+bkg_dir, tree_prod_name=tree_prod_name, xsec=W4JetsToLNu    .xSection, sumweights=W4JetsToLNu    .nGenEvents),
...
#        SampleCfg(name='QCD_pt_80to120_em', dir_name=QCD_pt_80to120_em.name, ana_dir=analysis_dir+qcd_dir, tree_prod_name=tree_prod_name, xsec=QCD_pt_80to120_em.xSection, sumweights=QCD_pt_80to120_em.nGenEvents),  #NOT IN DAS
    ...
    samples     = samples_essential + samples_additional_e + samples_qcd_e + samples_data
    ...
    if channel == 'm':
        # samples_mc = samples_essential + samples_additional_m + samples_qcd_mu
        # samples_mc = samples_essential + samples_additional_m
        samples_mc = samples_essential 
    ...
    initial_weights['HN3L_M3_e'          ] = 1.
    initial_weights['HN3L_M2_m'          ] = 1.
    initial_weights['HN3L_M2_e'          ] = 1.
