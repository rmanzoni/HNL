from CMGTools.HNL.prod.update_deepjet_and_ele_id_data2018ABC_cfg import process, cms
...
new_high_pt_cut = process.goodLowPtEles.cut.value().replace('mvaEleID-Fall17-noIso-V2-wp90', 'mvaEleID_Fall17_noIso_V2_wp90').replace('mvaEleID-Fall17-iso-V2-wp90', 'mvaEleID_Fall17_iso_V2_wp90')
